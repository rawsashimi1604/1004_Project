...
class Cart { 
    ...
    public function total(){ 
        return number_format((float) ltrim($this->cart_contents['cart_total'], '$'), 2, '.', '');
    } 
    ...
    protected function save_cart(){ 
        ...
        foreach ($this->cart_contents as $key => $val){ 
            ...
            $this->cart_contents['cart_total'] += ($val['price'] * 1); 
            $this->cart_contents['total_items'] += 1; 
            $this->cart_contents[$key]['subtotal'] = ($this->cart_contents[$key]['price'] * 1); 
