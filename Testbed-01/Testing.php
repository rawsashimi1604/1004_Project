...
//        
//        echo($appid. ", ".$name. ", ".$price. ", ".$description. ", ".$image. ", ".$developer. ", ".$publisher);
//        echo("<br/>");
//        
//        //Database upload statements. Need create the appropriate table and columns in MySQL.
//        $stmt = $conn->prepare("INSERT INTO apps_list (appid, name, price, description, image, developer, publisher) VALUES (?, ?, ?, ?, ?, ?, ?)");
